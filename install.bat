@echo off
title iMouse 专业版 V2.0 - Install
cd /d "%~dp0"

echo ============================================
echo    iMouse 专业版 V2.0 - Install
echo ============================================
echo.
...
if not defined PYTHON_EXE (
    ...
    echo Please run python-installer.exe manually,
...
"%PYTHON_EXE%" -m pip install --no-index --find-links="%~dp0packages" openpyxl requests pillow
if %errorlevel% neq 0 (
    echo.
